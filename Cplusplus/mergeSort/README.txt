...
This C++ program contains a mergesort algorithm applied over C++ arrays: is an efficient, general-purpose, comparison-based sorting algorithm (https://en.wikipedia.org/wiki/Merge_sort). Is is a divide and conquer algorithm which works as follows:
